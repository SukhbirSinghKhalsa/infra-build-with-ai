...
module "networking" {
  ...
  subnets = {
    private_endpoint = {
      ...
      address_prefixes = ["10.20.0.1.0/24"]
      vnet_key         = "main"
    }
    workload = {
      name             = "snet-workload"
      address_prefixes = ["10.20.0.2.0/24"]
      vnet_key         = "main"
    }
  }
}
